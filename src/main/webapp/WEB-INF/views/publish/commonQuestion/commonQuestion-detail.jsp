			...
			<div class="main-content-inner">
				...
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li id="editli"class="active">常见问题编辑</li>
						<li id="viewli"class="active" style="display:none">常见问题查看</li>
					</ul>
						...
						<form class="form-horizontal validate-form" id="mainForm" name="mainForm"role="form" action="${ctx}/commonQuestion/save" method="post" command="commonQuestion">
							<div class="form-group">
								...
								<div class="col-sm-10 controls">
									<div class="col-md-6 ">
										<input type="text" class="col-sm-12" id="question" name="question" value="${commonQuestion.question}"placeholder="" data-original-title="" reg="." tip="请输入字符小于200的问题！" data-placement="bottom">
									</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10 controls">
									<div class="col-md-6 ">
										...
										reg="." data-original-title="请输入问题解答！" tip="请输入问题解答！">${commonQuestion.content}</textarea>
									</div>
									<div class="col-md-6">&nbsp;</div>
								</div>
							</div>
							<input type="hidden" name="id"value="${commonQuestion.id}">
							<div class="clearfix form-actions"style="background-color:#FFF;border-top:0px solid #E5E5E5;margin-left: 30%;">
								<div style="margin-top: 30px;" id="edit">
								...
								<div style="margin-top: 30px;display:none" id="view">
									<button class="btn" type="button"
										onclick="javascript:backList();">
										<i class="ace-icon fa fa-undo bigger-110"></i> 返回
									</button>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
		...
		//type=1,进入查看页面，不可编辑
		if(type==1){
			$('input,textarea',$('form[name="mainForm"]')).attr('readonly',true);
			$('#edit').attr('style',"display:none");
			$('#view').attr('style',"display:block");
			$('#editli').attr('style',"display:none");
			$('#viewli').attr('style',"display:inline");
