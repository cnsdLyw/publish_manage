...
<head>
    ...
    <link rel="stylesheet" href="${ctx }/resources/zTree_v3/css/zTreeStyle/zTreeStyle.css">
    <script type="text/javascript" src="${ctx }/resources/zTree_v3/js/jquery-1.4.4.min.js"></script>
    <script src="${ctx }/resources/zTree_v3/js/jquery.ztree.all-3.5.min.js"></script>
</head>
<body>
<script>
    var zTree;
