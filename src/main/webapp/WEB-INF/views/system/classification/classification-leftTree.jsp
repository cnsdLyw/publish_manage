...
<body class="no-skin">
	<div class="main-container" id="main-container">
		<div class="main-content">
			<div class="main-content-inner">
						<button id="add-button" type="button" class="btn btn-sm btn-primary pull-right" title="添加根节点" onclick="javascript:window.parent.addClass('${classKey}')" style="display: none;">
							<i class="ace-icon fa fa-plus"></i>
							添加
						</button>
					 <!-- 
					 <a class="green" href="" title="点击修改"> <i
	...
	<script src="${ctx }/resources/script/bootstrap/js/fuelux/fuelux.tree-JCClassification.js"></script>
		<!-- ace scripts -->
	...
	jQuery(function($){
			...
			*/
			var dataSource = function(options, callback){
				...
				if(!("text" in options) && !("type" in options)){
					$.ajax( {  
						type : "get",  
						url : "${ctx}/classification/getAllTreeData/?classKey=${classKey}&classCode=${classCode}",
						dataType:"json",  
						async:false,
		...
		$("#treeview").on("selected.fu.tree",function(e,data){//e,事件。点击节点
			window.open("${ctx }/classification/updateClass?classkey=${classKey}&classCode=" + data.target.code, "main_content_configure");
		});
