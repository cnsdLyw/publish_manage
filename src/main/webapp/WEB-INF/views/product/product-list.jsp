										...
										<table id="dynamic-table"
											...
											<thead>
												<tr user="row">
													...
													<th class="sorting" id="loginName" tabindex="0" onclick="javascript:sort(this,'queryForm','loginName','asc');">产品代码</th>
													<th class="sorting" id="name" tabindex="0" onclick="javascript:sort(this,'queryForm','name','asc');">产品名称</th>
													<th>操作</th>
												</tr>
											</thead>
											<tbody>
