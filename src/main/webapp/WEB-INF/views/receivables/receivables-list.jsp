										...
										<table id="dynamic-table"
											...
											<thead>
												<tr user="row">
													...
													<th class="sorting" id="loginName" tabindex="0" onclick="javascript:sort(this,'queryForm','loginName','asc');">款项</th>
													...
													<th class="sorting" id="name" tabindex="0" onclick="javascript:sort(this,'queryForm','name','asc');">xxxxxx</th>
													<th class="sorting" id="name" tabindex="0" onclick="javascript:sort(this,'queryForm','name','asc');">xxxxxx</th>
													<th class="sorting" id="name" tabindex="0" onclick="javascript:sort(this,'queryForm','name','asc');">结款时间</th>
													<th>操作</th>
												</tr>
											</thead>
											<tbody>
