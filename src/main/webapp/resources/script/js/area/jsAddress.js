var chooseProvince = "-请选择省份-";
var chooseCity = "-请选择城市-";
var chooseCounty = "-请选择区/县-";
var addressInit = function(_cmbProvince, _cmbCity, _cmbArea, defaultProvince, defaultCity, defaultArea)
{
	...
	function cmbAddOption(cmb, str, obj)
	{
		...
		if(str==chooseProvince||str==chooseCity||str==chooseCounty){
			option.value = '';
		}else{
			option.value = str;
		}
...
var provinceList = [
{name:chooseProvince, cityList:[		   
{name:chooseCity, areaList:[chooseCounty]}
]},
{name:'北京市', cityList:[
{name:chooseCity, areaList:[chooseCounty]},
{name:'市辖区', areaList:['东城区','西城区','崇文区','宣武区','朝阳区','丰台区','石景山区','海淀区','门头沟区','房山区','通州区','顺义区','昌平区','大兴区','怀柔区','平谷区','密云区','延庆区']},		   
]},
{name:'上海市', cityList:[
{name:chooseCity, areaList:[chooseCounty]},
