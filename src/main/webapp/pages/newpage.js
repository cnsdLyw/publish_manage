...
var ms = {
	...
	fillHtml : function(obj, args) {
		return (function() {
			...
			/*obj.append('<span class="pagecount">共' + args.pageCount
					+ '页</span>');*/
			// 跳转页码
			if (args.turndown == 'true') {
				obj
						.append('<span class="countYe">到第<input type="text" maxlength='
								+ args.pageCount.toString().length
								+ '>页<a href="javascript:;" class="turndown">确定</a><span>');
			}
		})();
	},
	// 绑定事件
	bindEvent : function(obj, args) {
		return (function() {
			...
			obj.on("click", "a.prevPage", function() {
				...
				document.getElementById("pageNo").value=current-2;
				document.getElementById("queryForm").submit();
				ms.fillHtml(obj, {
					"current" : current - 1,
					"pageCount" : args.pageCount,
