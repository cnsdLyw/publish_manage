...
/**
 *  Function:获取大文件的MD5编码
 *  @author  zhongying(281264212@qq.com)
 *  @date    2015-12-9 下午2:14:05    
 *  @version 1.0
 */
public class Md5 {
...
//        String fileName = "E:\\Office_2010_Toolkit_2.2.3_XiaZaiBa.zip";
        String fileName = "E:\\开发软件\\win7\\cn_windows_7_ultimate_with_sp1_x64_dvd_u_677408_sj.iso";
////        String fileName = "E:\\SoTowerStudio-3.1.0.exe";
        ...
        System.out.println("一共耗时:"+result+"毫秒");
        System.out.println("一共耗时:"+result/1000+"秒");
        
//        代码第50行严重错误，看看DigestUtils.md5Hex(byte[] bytes) 的doc：
//        Calculates the MD5 digest and returns the value as a 32 character hex string.
//        说明该方法是首先计算bytes的MD5，然后以32为字符串显示出来，这样做其实是对已经digest出来的结果再digest一次，当然就不对了。应该做的是直接以32位字符串的形式显示出来，就是第52行的代码才是正确的
